...
if (process.env.AWS_SAM_LOCAL) {
  ...
  ballotsTableName = "abc_election_ballots_local";
  precinctsTableName = "abc_election_precincts_local";
  ...
  static async adminEndpointWorkflowAllowed(endpoint, election = false) {
    ...
    switch (endpoint) {
      ...
      case apiEndpoint.archiveElection:
        return Election.testConditions(endpoint, election, [
          [liveCurrentElection, "Election is in a live state"],
          // [
