    ...
    <LoggedInLayout title="Dashboard">
      ...
      {!loadingElections && (
        <Section>
          ...
          {!currentElection && (
            <Typography variant="h3">No current election.</Typography>
          )}
        </Section>
      )}
      {!loadingElections && (
        <Section>
          ...
          {openElections.length === 0 && (
            <Typography variant="h3">No Open Election</Typography>
          )}
      ...
      {!loadingElections && (
        <Section>
          ...
          {testElections.length === 0 && (
            <Typography variant="h3">No Test Election</Typography>
          )}
          <GC direction="column" spacing={2}>
        ...
        <Section>
          ...
          <GC direction="column" spacing={2}>
            ...
            {pendingElections.length === 0 && (
              <GI>
                <Typography variant="h3">No Draft Elections</Typography>
              </GI>
            )}
            <GI>
              <GC>
        ...
        <Section>
          ...
          <GC direction="column" spacing={2}>
            ...
            {closedElections.length === 0 && (
              <GI>
                <Typography variant="h3">No Closed Elections</Typography>
              </GI>
            )}
          </GC>
        </Section>
